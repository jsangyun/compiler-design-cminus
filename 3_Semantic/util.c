 ...
 * node for syntax tree construction
 */
TreeNode * newPrmNode(PrmKind kind)
{ TreeNode * t = (TreeNode *) malloc(sizeof(TreeNode));
  int i;
  if (t==NULL)
    fprintf(listing,"Out of memory error at line %d\n",lineno);
...
char * getTypeString (ExpType type) 
{ switch (type) 
  {
  case Integer: return "int"; break;
  case IntArray: return "int[]"; break;
  case Void: return "void"; break;
  case VoidArray: return "void[]"; break;
  ...
  while (tree != NULL) {
    ...
    { switch (tree->kind.prm) {
      ...
      case ParamK:
        ...
        break;
      default:
        fprintf(listing, "Unknown PrmKind Node");
        break;
      }
    }
